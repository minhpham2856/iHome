...
{
	// CRUD khách thuê trong phạm vi quản lý (kể cả khách tự tạo chưa gắn HĐ)
	public class TenantService
	{
		...
		// Lưới: khách trên HĐ + khách chưa gán (khi không lọc theo tòa)
		...
		// Combo khách có thể đưa vào hợp đồng mới
		...
		// Form sửa — ném nếu ngoài phạm vi
		...
		// Thêm khách (CCCD toàn hệ thống phải duy nhất)
