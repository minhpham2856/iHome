...
{
	// Bulk-assign services to many rooms — checkbox lists; returns selected ids
	public partial class AssignServiceDialog : Window
	{
		...
		// Selected ids after Save — ServicesPage reads these after ShowDialog
		...
		// Require at least one room and one service, then close OK
