...
{
	// Add/edit building under a property — optional manager from landlord staff list
	public partial class BuildingDialog : Window
	{
		...
		public BuildingDialog(int propertyId, List<ManagerOptionDto> managers, BuildingFormDto? building = null)
		{
			...
			// Former manager may be missing from list — fall back to index 0 ("unassigned")
		...
		// Validate name and floors ≥ 1, then build Result
		...
		// Enter moves focus through main fields
