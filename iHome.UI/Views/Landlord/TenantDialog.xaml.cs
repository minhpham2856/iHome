...
{
	// Edit tenant profile — landlord updates only (no create from this dialog)
	public partial class TenantDialog : Window
	{
		...
		// Validate required fields, then build Result
		...
		// Enter moves focus from name through fields to Save
